...
(function(){
  ...
  en: {
    ...
    'auth.signup': 'Sign up',
    'hero.h1': "Trails scored for your dog's paws",
    'hero.sub': "Because they'd walk anywhere for you. We check every trail for heat, terrain, water and climb, so their happy paws stay that way.",
  ...
  it: {
    ...
    'hero.h1': 'Sentieri valutati per le zampe del tuo cane',
    'hero.sub': "Perché loro ti seguirebbero ovunque. Controlliamo ogni sentiero per caldo, terreno, acqua e dislivello, così le loro zampe felici restano tali.",
