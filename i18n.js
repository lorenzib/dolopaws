...
(function(){
  ...
  en: {
    ...
    'hero.sub': "Every route is ranked for paw safety, shade, water access, and terrain risk, matched to your dog's build and tolerance.",
    ...
    'home.pickArea': 'Pick an area below — trails are ranked for {name}.',
    'home.pickAreaNoName': 'Pick an area below — trails are ranked for your dog.',
    ...
    'trail.verifiedShort': 'Verified by DoloPaws',
  ...
  it: {
    ...
    'hero.h1': 'La guida che chiede prima del tuo cane, poi della tua forma fisica',
    'hero.sub': "Ogni itinerario è valutato per sicurezza delle zampe, ombra, accesso all'acqua e rischio del terreno, su misura per la corporatura e la tolleranza del tuo cane.",
    ...
    'home.pickArea': 'Scegli una zona qui sotto — i sentieri sono classificati per {name}.',
    'home.pickAreaNoName': 'Scegli una zona qui sotto — i sentieri sono classificati per il tuo cane.',
    ...
    'trail.verifiedShort': 'Verificato da DoloPaws',
