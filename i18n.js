...
(function(){
  ...
  en: {
    ...
    'browse.trustNote': '<strong>How to read safety labels:</strong> DoloPaws-curated trails contain manually prepared details, but review dates are not yet recorded. Imported trail ratings are automated estimates and do not confirm exposure, shade, livestock or current conditions.',
  ...
  it: {
    ...
    'browse.trustNote': '<strong>Come leggere le valutazioni:</strong> i sentieri curati da DoloPaws contengono dettagli preparati manualmente, ma le date di revisione non sono ancora registrate. Le valutazioni dei sentieri importati sono stime automatiche e non confermano esposizione, ombra, bestiame o condizioni attuali.',
