...
(function(){
  ...
  en: {
    ...
    'home.adjust': '<span aria-hidden="true">⚡</span> Adjust for today\'s conditions',
    ...
    'account.photo.upload': '<span aria-hidden="true">📸</span> Upload a photo',
    'account.photo.remove': 'Remove photo',
    'account.photo.hint': 'Saved in your browser and shown on the home screen.',
    ...
    'account.photo.sizeError': 'Photo must be smaller than 2 MB.',
    'filter.all': 'All',
  ...
  it: {
    ...
    'home.adjust': '<span aria-hidden="true">⚡</span> Adatta alle condizioni di oggi',
    ...
    'account.photo.upload': '<span aria-hidden="true">📸</span> Carica una foto',
    'account.photo.remove': 'Rimuovi foto',
    'account.photo.hint': 'Salvata nel browser e mostrata nella schermata iniziale.',
    ...
    'account.photo.sizeError': 'La foto deve essere inferiore a 2 MB.',
    'filter.all': 'Tutti',
