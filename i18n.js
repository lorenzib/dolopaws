...
(function(){
  ...
  en: {
    ...
    'auth.signup': 'Sign up',
    'hero.h1': 'The trail guide that asks about your dog before your fitness level',
    'hero.sub': "DoloPaws ranks every Dolomites route by paw safety, shade, water access, and terrain risk — matched to your specific dog's build and tolerance.",
    ...
    'badge.imported': '🗺️ IMPORTED',
    'badge.new': 'NEW MATCH',
    'badge.verifiedS': '🐾 Verified',
    'badge.importedS': '🗺️ Imported',
    'card.save': 'Save',
    'card.saved': 'Saved',
    'card.match': '{n}% match',
    ...
    'reports.intro': "Recent dog-safety observations from hikers. These appear alongside DoloPaws' verified rating — they never replace it.",
    ...
    'reports.modalHint': "Help the next dog owner. Your report shows alongside DoloPaws' verified rating — it never replaces it.",
    ...
    'trail.tip': 'Tip: {tip}',
    'trail.dirStart': '{label} (km 0).',
    'trail.dirStartAt': 'Start at {name} (km 0).',
    ...
    'guide.subline': "The things that cause the most trouble on alpine trails aren't the elevation — they're paws, heat, pace, and knowing your dog's build.",
  ...
  it: {
    ...
    'hero.h1': 'La guida ai sentieri che chiede prima del tuo cane, poi della tua forma fisica',
    'hero.sub': "DoloPaws valuta ogni itinerario delle Dolomiti per sicurezza delle zampe, ombra, accesso all'acqua e rischio del terreno — su misura per la corporatura e la tolleranza del tuo cane.",
    ...
    'home.welcomeFor': 'Bentornati — sentieri su misura per {name}',
    ...
    'badge.imported': '🗺️ IMPORTATO',
    'badge.new': 'NUOVO MATCH',
    'badge.verifiedS': '🐾 Verificato',
    'badge.importedS': '🗺️ Importato',
    'card.save': 'Salva',
    'card.saved': 'Salvato',
    ...
    'reports.intro': 'Osservazioni recenti degli escursionisti sulla sicurezza per i cani. Compaiono accanto alla valutazione verificata di DoloPaws — non la sostituiscono mai.',
    ...
    'reports.modalHint': 'Aiuta il prossimo escursionista. La tua segnalazione appare accanto alla valutazione verificata di DoloPaws — non la sostituisce mai.',
    ...
    'trail.dirStart': '{label} (km 0).',
    'trail.dirStartAt': 'Partenza da {name} (km 0).',
    ...
    'guide.subline': 'I problemi più frequenti sui sentieri alpini non dipendono dall\'altitudine — ma da zampe, caldo, ritmo e dal conoscere la corporatura del tuo cane.',
