...
(function(){
  ...
  en: {
    ...
    'auth.signup': 'Sign up',
    'hero.h1': 'DoloPaws — the Dolomites trail guide for dogs and their humans',
    'hero.sub': "The trail guide that asks about your dog before your fitness level: every route is ranked by paw safety, shade, water access, and terrain risk — matched to your specific dog's build and tolerance.",
    ...
    'trust.breeds': 'Every breed is different — scores adapt to your dog',
    'guest.trailCount': '{n} dog-friendly trails mapped',
    'guest.franceBanner': '🇫🇷 DoloPaws has expanded to France!',
  ...
  it: {
    ...
    'hero.h1': 'DoloPaws — la guida ai sentieri delle Dolomiti per i cani e i loro umani',
    ...
    'trust.breeds': 'Ogni razza è diversa — i punteggi si adattano al tuo cane',
    'guest.trailCount': '{n} sentieri dog-friendly mappati',
    'guest.franceBanner': '🇫🇷 DoloPaws è arrivato in Francia!',
