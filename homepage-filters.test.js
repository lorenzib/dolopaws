...
describe('returning homepage province + valley filters', () => {
  const sampleTrails = [
    ...
    { id: 'dol', name: 'Dolomites Trail', region: 'dolomites', valley: 'Val Gardena', area: 'Ortisei', lat: 46.57, lng: 11.67, curated: true, distance: 6, elevation: 320, hours: 3, terrainType: 'Mixed', safetyLevel: 'low-risk' },
  ];
